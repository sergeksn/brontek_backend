...
function isMobile() {
    ...
    if($user_agent === "KSN_site_caching_desktop" || $user_agent === "KSN_site_caching_tablet"){
        return false;
    }

    if($user_agent === "KSN_site_caching_mobile"){
        return true;
    }
...
function isTablet() {
    ...
    if($user_agent === "KSN_site_caching_desktop" || $user_agent === "KSN_site_caching_mobile"){
        return false;
    }

    if($user_agent === "KSN_site_caching_tablet"){
        return true;
    }
...
function isDesktop() {
    ...
    if($user_agent === "KSN_site_caching_tablet" || $user_agent === "KSN_site_caching_mobile"){
        return false;
    }

    if($user_agent === "KSN_site_caching_desktop"){
        return true;
    }
