...
$test = (int) $ab_memcached->get($ab_config['memcached_prefix'].'test_'.$date) + 0;
$auto = (int) $ab_memcached->get($ab_config['memcached_prefix'].'auto_'.$date) + 0;
$click = (int) $ab_memcached->get($ab_config['memcached_prefix'].'click_'.$date) + 0;
$uusers = (int) $ab_memcached->get($ab_config['memcached_prefix'].'uusers_'.$date) + 0;
$husers = (int) $ab_memcached->get($ab_config['memcached_prefix'].'husers_'.$date) + 0;
$whits = (int) $ab_memcached->get($ab_config['memcached_prefix'].'whits_'.$date) + 0;
$bbots = (int) $ab_memcached->get($ab_config['memcached_prefix'].'bbots_'.$date) + 0;
$fakes = (int) $ab_memcached->get($ab_config['memcached_prefix'].'fakes_'.$date) + 0;

$google = (int) $ab_memcached->get($ab_config['memcached_prefix'].'google_'.$date) + 0;
$yandex = (int) $ab_memcached->get($ab_config['memcached_prefix'].'yandex_'.$date) + 0;
$mailru = (int) $ab_memcached->get($ab_config['memcached_prefix'].'mailru_'.$date) + 0;
$bing = (int) $ab_memcached->get($ab_config['memcached_prefix'].'bing_'.$date) + 0;
