...
$pt['File /antibot/data/counter.txt - is designed to insert html or js code of statistics counters (Google Analytics, etc.).'] = 'Plik /antibot/data/counter.txt przeznaczony jest do wstawiania kodu html i js liczników statystyk (Google Analytics, itp.).';
// adm/counters.php
...
$pt['the number (percentage) of "Clicked" relative to "Automatic". If more than 10%, then this requires attention.'] = 'liczba (procent) „Kliknięć” w stosunku do „Automatycznie”. Jeśli więcej niż 10%, wymaga to uwagi.';
...
// adm/hits.php
$pt['Delete this selection'] = 'Usuń ten wybór';
$pt['The selection has been deleted.'] = 'Wybór został usunięty.';
$pt['Found matches:'] = 'Znalezione dopasowania:';
$pt['All time'] = 'Cały czas';
$pt['Today'] = 'Dzisiaj';
$pt['Yesterday'] = 'Wczoraj';
$pt['Last Week'] = 'Tydzień';
$pt['Last Month'] = 'Miesiąc';
$pt['Last Year'] = 'Ostatni rok';
$pt['Search:'] = 'Szukaj:';
$pt['table:'] = 'tabela:';
...
$pt['Older than a day'] = 'Starsze niż dzień';
$pt['Older than a week'] = 'Starsze niż tydzień';
$pt['Older than a month'] = 'Starsza niż miesiąc';
$pt['Older than a year'] = 'Starsza niż rok';
$pt['deleting old records by cron'] = 'usuwanie starych rekordów przez cron';
$pt['Check with your hosting provider on how to run a php script in a crontab.'] = 'Skontaktuj się ze swoim dostawcą usług hostingowych, aby dowiedzieć się, jak uruchomić skrypt php w pliku crontab.';
$pt['Instead of lastmonth, the following values are possible:'] = 'Zamiast lastmonth możliwe są następujące wartości:';
// adm/importrules.php
$pt['Example:'] = 'Przykład:';
...
// adm/index.php
$pt['The database file has a server response code of 200. It may be available for download. This is unsafe because the database may contain confidential data. Protect the database file from web access.'] = 'Plik bazy danych ma kod odpowiedzi serwera 200. Może być dostępny do pobrania. Jest to niebezpieczne, ponieważ baza danych może zawierać dane poufne. Chroń plik bazy danych przed dostępem do sieci.';
...
$pt['this is the only official Telegram support account. Beware of scammers!'] = 'jest to jedyne oficjalne konto pomocy technicznej Telegram. Uważaj na oszustów!';
...
$pt['1 domain and any subdomains of it. $30 for the first year, $10 per year - renewal.'] = '1 domena i wszelkie jej subdomeny. 30$ za pierwszy rok, 10$ rocznie - odnowienie.';
$pt['Without restrictions of domains, subdomains and without bindings to domains. $99 for the first year, $33 per year - renewal.'] = 'Bez ograniczeń domen, subdomen i bez powiązań z domenami. 99$ za pierwszy rok, 33$ rocznie - odnowienie.';
$pt['+10 days free trial period to test the cloud version after registering on the site:'] = '+ 10 dni darmowych testów wersji w chmurze po rejestracji na stronie:';
// adm/lang.php
...
$pt['Condition:'] = 'Stan:';
$pt['Rules by user-agent, country, language, referrer, ptr - you can add only to the black list.'] = 'Reguły według agent użytkownika, kraju, języka, referrera, ptr - możesz dodać tylko do czarnej listy.';
$pt['Blocking by user-agent'] = 'Blokowanie według klienta użytkownika';
$pt['add a full string like:'] = 'dodaj całą linię jak:';
...
$pt['Remove all many_buttons_ban rules'] = 'Usuń wszystkie reguły many_buttons_ban';
// adm/tpl.php
...
$pt['https://antibot.cloud/antibot/changelog.txt'] = 'https://antibot.cloud/antibot/changelog.txt';
// adm/error.php
