...
// adm/clearfake.php
$pt['Empty the records'] = 'Удалить все записи';
// adm/conf.php
...
$pt['File /antibot/data/counter.txt - is designed to insert html or js code of statistics counters (Google Analytics, etc.).'] = 'Файл /antibot/data/counter.txt - предназначен для вставки html и js кода счетчиков статистики (Google Analytics и т.п.). <br /><span class="text-danger">НЕ добавляйте Яндекс Метрику, т.к. она будет считать и ботов, которые не прошли и это испортит поведенческие факторы.</span>';
// adm/counters.php
...
$pt['the number (percentage) of "Clicked" relative to "Automatic". If more than 10%, then this requires attention.'] = 'процент "кликнувших" относительно "прошедших автоматически". Если больше 10%, то это требует внимания.';
$pt['Unique'] = 'Уников';
...
$pt['The selection has been deleted.'] = 'Выборка успешно удалена.';
$pt['Found matches:'] = 'Найдено совпадений:';
$pt['All time'] = 'За все время';
$pt['Today'] = 'За сегодня';
$pt['Yesterday'] = 'За вчера';
...
$pt['deleting old records by cron'] = 'удаление старых записей по крону';
$pt['Check with your hosting provider on how to run a php script in a crontab.'] = 'Уточните у своего хостинг провайдера как запускать php скрипты по крону.';
$pt['Instead of lastmonth, the following values are possible:'] = 'Вместо lastmonth возможны значения:';
// adm/importrules.php
$pt['Example:'] = 'Пример:';
...
// adm/index.php
$pt['The database file has a server response code of 200. It may be available for download. This is unsafe because the database may contain confidential data. Protect the database file from web access.'] = 'Файл базы имеет код ответа сервера 200. Возможно он доступен для скачивания. Это небезопасно, т.к. база может содержать конфиденциальные данные. Защитите файл базы от веб доступа.';
...
$pt['this is the only official Telegram support account. Beware of scammers!'] = 'это единственный официальный аккаунт службы поддержки в телеграм. Остерегайтесь мошенников!';
...
$pt['1 domain and any subdomains of it. $30 for the first year, $10 per year - renewal.'] = '1 домен и любые его поддомены. 30$ за первый год, 10$ в год - продление.';
$pt['Without restrictions of domains, subdomains and without bindings to domains. $99 for the first year, $33 per year - renewal.'] = 'Без ограничений доменов, поддоменов и без привязок к доменам. 99$ за первый год, 33$ в год - продление.';
$pt['+10 days free trial period to test the cloud version after registering on the site:'] = '+10 дней бесплатно для тестирования облачной версии после регистрации на сайте:';
// adm/lang.php
...
$pt['Rules by user-agent, country, language, referrer, ptr - you can add only to the black list.'] = 'Правила по юзер-агенту, стране, языку, рефереру, ptr - можно добавлять только в черный список.';
$pt['Blocking by user-agent'] = 'Блокировка по user-agent';
$pt['add a full string like:'] = 'добавлять полную строку вида:';
...
$pt['Remove all many_buttons_ban rules'] = 'Удалить все many_buttons_ban правила';
// adm/tpl.php
...
$pt['https://antibot.cloud/antibot/changelog.txt'] = 'https://antibot.cloud/antibot/changelog_ru.txt';
// adm/error.php
