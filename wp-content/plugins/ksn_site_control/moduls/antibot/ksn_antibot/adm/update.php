...
$content .= '<div class="alert alert-info" role="alert">'.abTranslate('Your software version:').' '.$ab_version.' (<a href="'.abTranslate('https://antibot.cloud/antibot/changelog.txt').'" target="_blank" rel="noopener">changelog</a>)</div>
